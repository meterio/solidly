...
contract BaseV1BribeFactoryUpgradeable {
    address public last_gauge;

    function createBribe() external returns (address) {
        last_gauge = address(new BribeUpgradeable(msg.sender));
        return last_gauge;
    }
}
