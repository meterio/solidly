...
contract BaseV1GaugeFactoryUpgradeable {
    ...
    function createGauge(
        ...
        last_gauge = address(new GaugeUpgradeable(_pool, _bribe, _ve, msg.sender));
        return last_gauge;
    }
    ...
    function createGaugeSingle(
        ...
        last_gauge = address(new GaugeUpgradeable(_pool, _bribe, _ve, _voter));
        return last_gauge;
    }
}
