...
describe("base old tests", function () {
  ...
  it("deploy VoltFactory and test pair length", async function () {
    const treasury = await Deploy.deployGovernanceTreasury(owner);
    const VoltFactory = await ethers.getContractFactory("VoltFactory");
    factory = await VoltFactory.deploy(treasury.address);
    await factory.deployed();

    expect(await factory.allPairsLength()).to.equal(0);
  });

  it("deploy VoltRouter01 and test factory address", async function () {
    const VoltRouter01 = await ethers.getContractFactory("VoltRouter01");
    router = await VoltRouter01.deploy(factory.address, owner.address);
    await router.deployed();

    expect(await router.factory()).to.equal(factory.address);
  });

  it("deploy pair via VoltFactory owner", async function () {
  ...
  it("deploy pair via VoltFactory owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const dai_1 = ethers.BigNumber.from("1000000000000000000");
  ...
  it("VoltRouter01 addLiquidity", async function () {
  ...
  it("VoltRouter01 removeLiquidity", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("VoltRouter01 addLiquidity owner2", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("VoltRouter01 pair1 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("VoltRouter01 pair1 getAmountsOut & swapExactTokensForTokens owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const route = {from: ust.address, to: mim.address, stable: true}
  ...
  it("VoltRouter01 pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("VoltRouter01 pair3 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("deploy VoltVoter", async function () {
    ...
    voter = await VoltVoter.deploy(ve.address, factory.address, gauges_factory.address, bribe_factory.address);
  ...
  it("deploy VoltFactory gauge", async function () {
  ...
  it("deploy VoltFactory gauge owner2", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
  ...
  it("VoltRouter01 pair1>pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const route = [{from: mim.address, to: ust.address, stable: false}, {
      from: ust.address,
      to: mim.address,
  ...
  it("VoltRouter01 addLiquidity owner3", async function () {
  ...
  it("deploy VoltFactory gauge owner3", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
