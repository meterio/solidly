...
interface BaseV1BribeFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseV1BribeFactory extends BaseContract {
  ...
  interface: BaseV1BribeFactoryInterface;
