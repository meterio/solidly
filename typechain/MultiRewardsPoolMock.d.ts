...
interface MultiRewardsPoolMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testDoubleDeposit(uint256)": FunctionFragment;
    "testDoubleWithdraw(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDoubleDeposit",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "testDoubleWithdraw",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class MultiRewardsPoolMock extends BaseContract {
  ...
  interface: MultiRewardsPoolMockInterface;
