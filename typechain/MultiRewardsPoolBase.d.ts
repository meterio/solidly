...
interface MultiRewardsPoolBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class MultiRewardsPoolBase extends BaseContract {
  ...
  interface: MultiRewardsPoolBaseInterface;
